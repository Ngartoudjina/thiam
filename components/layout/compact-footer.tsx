...
export function CompactFooter({
  ...
  return (
    <footer className="flex flex-col items-start gap-7 border-t border-rule-dark bg-obsidian gutter py-14 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
